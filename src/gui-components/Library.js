                    ...
                    {Object.entries(components).map(([id, obj], index) => {
                        ...
                        if (text) {
                            const textObj = new fabric.Text(text.content, {
                                ...
                                originX: 'center',
                                originY: 'center',
                                left: 0.5 * text.area[0][0] + 0.5 * text.area[1][0] || canvasWidth / 2,
                                top: 0.5 * text.area[0][1] + 0.5 * text.area[1][1] || canvasHeight / 2,
                        ...
                        const inPins = createPins(obj.inpins, 'black');
                        const outPins = createPins(obj.outpins, 'black');
                        ...
                        return (
                            <div key={index} className="visual">
                                <button className="image-button" draggable="true" onDragStart={() => onDragStart(JSON.stringify(group))}
                                    style={{
